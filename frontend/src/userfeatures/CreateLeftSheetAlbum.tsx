...
const CreateLeftSheetAlbumDialog = () => {
  ...
  return (
    <Dialog open={albumDialogOpen} onOpenChange={setAlbumDialogOpen}>
      <DialogTrigger asChild>
        <Button className="text-white w-[240px] bg-gradient-to-r from-[#5038a0]/80 to-purple-900 hover:from-purple-900 hover:to-[#5038a0]/80">
...
export default CreateLeftSheetAlbumDialog;
