...
import AddSongsToAlbum from "./AddAlbumSongs";
...
const AlbumPage = () => {
  ...
  const { data: currentAlbum } = useGetAlbumById(albumId!);
  ...
  const deleteMutation = useMutation({
    mutationFn: async (songId: string) => {
      ...
      const response = await axiosInstance.delete("/songs/songs-album/delete", {
        headers: {
          ...
          <div className="relative z-10">
            <div className="custom-flex .show-at-920 p-6 gap-6 pb-8">
              ...
              <div className="flex flex-col justify-end">
                ...
                <div className="mt-5">
                  {isAdmin && <AddSongsToAlbum album={currentAlbum} />}
                </div>
              </div>
            </div>
