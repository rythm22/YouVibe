...
import { useGetAlbumSongs } from "@/hooks/songs/useSong";

interface AddSongsToAlbumDialogProps {
  album: Album;
}

const AddSongsToAlbum = ({ album }: AddSongsToAlbumDialogProps) => {
  ...
  const { data: albumSongs } = useGetAlbumSongs(album._id);
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["album-songs", album._id] });
    },
